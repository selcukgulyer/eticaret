                    ...
                    <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="" id="first-name" name="kullanici_tc" required="required" value="<?php echo $ayarcek['ayar_url']?>/sayfa-<?php echo seo($menucek['menu_ad']) ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select type="text" id="first-name" name="menu_durum"  required="required" class="form-control">
