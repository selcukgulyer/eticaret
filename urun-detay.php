				...
				<div class="row">
					...
					<div class="col-md-6 det-desc">
						<div class="productdata">
							...
							<div class="infospan">bişeyler ekle <span>-----</span></div>
							...
							<div class="form-group">
									...
									<div class="col-sm-4">
										...
										<?php } else { ?>
										<button type="submit" name="sepeteekle" disabled="" class="btn btn-default btn-red btn-sm"><span class="addchart">Sepete Ekle</span></button>
				...
				<div class="tab-review">
					...
					<div id="myTabContent" class="tab-content shop-tab-ct">
						...
						<div class="tab-pane fade <?php 
							...
							<input type="hidden" name="urun_id" value="<?php echo $uruncek['urun_id'] ?>">
							<button type="submit" name="yorumukaydet" class="btn btn-default btn-red btn-sm">Yorumu Gönder</button>
							</form>
							<?php	} else { ?>
					...
					<div class="col-md-4">
						<div class="productwrap">
							<div class="pr-img">
								...
								<div class="pricetag on-sale"><div class="inner on-sale"><span class="onsale"><span class="oldprice"><?php echo $urunaltcek['urun_fiyat']*1.50 ?> TL</span><?php echo $urunaltcek['urun_fiyat'] ?> </span></div></div>
							</div>
